...
class account_journal(models.Model):
    ...
    def get_journal_dashboard_datas(self):
        ...
        return {
            ...
            'sum_draft': self.formatLang(self.env, sum_draft or 0.0, currency_obj=self.currency.id or self.company_id.currency_id),
            'sum_waiting': self.formatLang(self.env, sum_waiting or 0.0, currency_obj=self.currency.id or self.company_id.currency_id),
